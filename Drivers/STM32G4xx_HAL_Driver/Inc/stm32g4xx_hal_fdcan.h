...
#include "stm32g4xx_hal_def.h"
  ...
  */
	typedef struct
	{
		...
		uint32_t
			TxFrameType; /*!< Specifies the frame type of the message that will be transmitted.
		...
		uint32_t
			BitRateSwitch; /*!< Specifies whether the Tx frame will be transmitted with or without
                                     bit rate switching.
  ...
  */
	typedef struct
	{
		...
		uint32_t
			BitRateSwitch; /*!< Specifies whether the Tx frame is transmitted with or without bit
                                     rate switching.
                                     This parameter can be a value of @ref FDCAN_bit_rate_switching    */
...
#	if USE_HAL_FDCAN_REGISTER_CALLBACKS == 1
		...
		void (*TxFifoEmptyCallback)(
			struct __FDCAN_HandleTypeDef* hfdcan); /*!< FDCAN Tx Fifo Empty callback         */
...
#	if USE_HAL_FDCAN_REGISTER_CALLBACKS == 1
  ...
  */
	typedef void (*pFDCAN_CallbackTypeDef)(
		FDCAN_HandleTypeDef* hfdcan); /*!< pointer to a common FDCAN callback function           */
...
#	define FDCAN_TIMESTAMP_PRESC_2                                                                \
		((uint32_t)0x00010000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 2  */
#	define FDCAN_TIMESTAMP_PRESC_3                                                                \
		((uint32_t)0x00020000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 3  */
#	define FDCAN_TIMESTAMP_PRESC_4                                                                \
		((uint32_t)0x00030000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 4  */
#	define FDCAN_TIMESTAMP_PRESC_5                                                                \
		((uint32_t)0x00040000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 5  */
#	define FDCAN_TIMESTAMP_PRESC_6                                                                \
		((uint32_t)0x00050000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 6  */
#	define FDCAN_TIMESTAMP_PRESC_7                                                                \
		((uint32_t)0x00060000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 7  */
#	define FDCAN_TIMESTAMP_PRESC_8                                                                \
		((uint32_t)0x00070000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 8  */
#	define FDCAN_TIMESTAMP_PRESC_9                                                                \
		((uint32_t)0x00080000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 9  */
#	define FDCAN_TIMESTAMP_PRESC_10                                                               \
		((uint32_t)0x00090000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 10 */
#	define FDCAN_TIMESTAMP_PRESC_11                                                               \
		((uint32_t)0x000A0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 11 */
#	define FDCAN_TIMESTAMP_PRESC_12                                                               \
		((uint32_t)0x000B0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 12 */
#	define FDCAN_TIMESTAMP_PRESC_13                                                               \
		((uint32_t)0x000C0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 13 */
#	define FDCAN_TIMESTAMP_PRESC_14                                                               \
		((uint32_t)0x000D0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 14 */
#	define FDCAN_TIMESTAMP_PRESC_15                                                               \
		((uint32_t)0x000E0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 15 */
#	define FDCAN_TIMESTAMP_PRESC_16                                                               \
		((uint32_t)0x000F0000U) /*!< Timestamp counter time unit in equal to CAN bit time multiplied by 16 */
/**
  * @}
  */
...
#	if USE_HAL_FDCAN_REGISTER_CALLBACKS == 1
	...
	HAL_StatusTypeDef HAL_FDCAN_UnRegisterCallback(FDCAN_HandleTypeDef* hfdcan,
												   HAL_FDCAN_CallbackIDTypeDef CallbackID);
	HAL_StatusTypeDef
	HAL_FDCAN_RegisterTxEventFifoCallback(FDCAN_HandleTypeDef* hfdcan,
	...
	HAL_StatusTypeDef
	HAL_FDCAN_RegisterTxBufferCompleteCallback(FDCAN_HandleTypeDef* hfdcan,
	...
	HAL_StatusTypeDef
	HAL_FDCAN_RegisterTxBufferAbortCallback(FDCAN_HandleTypeDef* hfdcan,
	...
	HAL_StatusTypeDef
	HAL_FDCAN_RegisterErrorStatusCallback(FDCAN_HandleTypeDef* hfdcan,
